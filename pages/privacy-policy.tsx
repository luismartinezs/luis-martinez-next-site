const PrivacyPolicyPage = () => {
  return (
    <div className="prose prose-invert mx-auto">
      ...
      <p>Our Privacy Policy was last updated on 6-August-2022.</p>
      <p>
      ...
      <p>
        ...
        by{" "}
        <a href="https://www.termsfeed.com/blog/privacy-policy-google-analytics/">
      ...
      <ul>
        ...
        <li>
          <p>
            ...
            "We", "Us" or "Our" in this Agreement) refers to Luis Martinez - Web Developer
          </p>
        </li>
        <li>
          <p>
        ...
        <li>
          <p>
            <strong>"Website"</strong> refers to Luis Martinez - Web Developer,
            accessible from https://luis-martinez.net
          </p>
        </li>
        <li>
          <p>
      ...
      <ul>
        <li>By sending us an email: luismartinezwebdev@gmail.com</li>
      </ul>
      <p></p>
    </div>
  );
