...
featuredImage: "/blog/vscode-search-specific-ignored-files.png"
---
...
![VS Code search configuration for gitignored files](/blog/vscode-search-specific-ignored-files.png)
