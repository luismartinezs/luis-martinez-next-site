...
featuredImage: "/blog/vscode-search-specific-ignored-files.webp"
---
...
![VS Code search configuration for gitignored files](/blog/vscode-search-specific-ignored-files.webp)
