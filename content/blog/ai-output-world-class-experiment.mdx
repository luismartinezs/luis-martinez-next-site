...
I was building <a href="https://hellosafelyfed.appforgelabs.com/menu-decoder" target="_blank" rel="noopener noreferrer">Menu Decoder<span className="sr-only"> (link opens in a new window)</span></a>, a travel app that helps people with dietary restrictions navigate foreign menus. I asked Claude to write the copy. It produced:

> **Ready to get started?**
> Try the app and see what it can do for you.
> *Try Menu Decoder*

![The generic CTA Claude generated. Could be for any product.](/blog/ai-experiment-generic-cta.webp)
...
![Same model, better direction. The copy now speaks to the actual fear.](/blog/ai-experiment-specific-cta.webp)
...
<div style={{display: 'flex', gap: '1rem', justifyContent: 'center', margin: '2rem 0'}}>
  <figure style={{margin: 0, textAlign: 'center', flex: '1', maxWidth: '33%'}}>
    <img src="/blog/ai-experiment-ui-bare-default.webp" alt="bare: default Tailwind output" style={{maxHeight: '520px', width: 'auto', margin: '0 auto', display: 'block', borderRadius: '8px'}} />
    <figcaption style={{fontSize: '0.85rem', color: '#9ca3af', marginTop: '0.5rem'}}>bare</figcaption>
  </figure>
  <figure style={{margin: 0, textAlign: 'center', flex: '1', maxWidth: '33%'}}>
    <img src="/blog/ai-experiment-ui-reference-style.webp" alt="reference_style: dark, flat, no shadows" style={{maxHeight: '520px', width: 'auto', margin: '0 auto', display: 'block', borderRadius: '8px'}} />
    <figcaption style={{fontSize: '0.85rem', color: '#9ca3af', marginTop: '0.5rem'}}>reference_style</figcaption>
  </figure>
  <figure style={{margin: 0, textAlign: 'center', flex: '1', maxWidth: '33%'}}>
    <img src="/blog/ai-experiment-ui-full-brief.webp" alt="full_brief: bold safety color blocks" style={{maxHeight: '520px', width: 'auto', margin: '0 auto', display: 'block', borderRadius: '8px'}} />
    <figcaption style={{fontSize: '0.85rem', color: '#9ca3af', marginTop: '0.5rem'}}>full_brief</figcaption>
  </figure>
</div>
...
<div style={{display: 'flex', gap: '1rem', justifyContent: 'center', margin: '2rem 0'}}>
  <figure style={{margin: 0, textAlign: 'center', flex: '1', maxWidth: '33%'}}>
    <img src="/blog/ai-experiment-ui-revision-pass0.webp" alt="Pass 0: initial generation" style={{maxHeight: '520px', width: 'auto', margin: '0 auto', display: 'block', borderRadius: '8px'}} />
    <figcaption style={{fontSize: '0.85rem', color: '#9ca3af', marginTop: '0.5rem'}}>Pass 0: initial</figcaption>
  </figure>
  <figure style={{margin: 0, textAlign: 'center', flex: '1', maxWidth: '33%'}}>
    <img src="/blog/ai-experiment-ui-revision-pass1.webp" alt="Pass 1: color blocks added, FAB still overlaps" style={{maxHeight: '520px', width: 'auto', margin: '0 auto', display: 'block', borderRadius: '8px'}} />
    <figcaption style={{fontSize: '0.85rem', color: '#9ca3af', marginTop: '0.5rem'}}>Pass 1: fixes applied</figcaption>
  </figure>
  <figure style={{margin: 0, textAlign: 'center', flex: '1', maxWidth: '33%'}}>
    <img src="/blog/ai-experiment-ui-revision-pass2.webp" alt="Pass 2: viewfinder crushed, layout lost coherence" style={{maxHeight: '520px', width: 'auto', margin: '0 auto', display: 'block', borderRadius: '8px'}} />
    <figcaption style={{fontSize: '0.85rem', color: '#9ca3af', marginTop: '0.5rem'}}>Pass 2: coherence lost</figcaption>
  </figure>
</div>
