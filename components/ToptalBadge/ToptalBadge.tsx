/**
 * Toptal "Top 3% Talent" badge. Currently unused, not mounted anywhere.
 *
 * If you mount it, add the Typekit stylesheet to pages/_document.tsx, otherwise
 * the badge falls back to Arial:
 *   <link rel="stylesheet" href="https://use.typekit.net/kmj5qkr.css" />
 */

import styles from "./ToptalBadge.module.css";

const RESUME_URL =
  "https://www.toptal.com/developers/resume/luis-martinez-suarez#NJyb2L";
    ...
    <div className={styles.root}>
      <div className={styles.frame}>
        <div className={styles.badge}>
          ...
          <h3 className={styles.title}>TOP 3% TALENT</h3>
          <div className={styles.divider} />
          <span className={styles.label}>Vetted by</span>
          <svg
